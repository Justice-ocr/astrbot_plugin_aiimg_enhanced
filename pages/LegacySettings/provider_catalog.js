...
const PROVIDER_TEMPLATES = {
  ...
  openai_video:           { label:'OpenAI Videos', base_url:'https://api.openai.com', api_keys:[], model:'sora-2', timeout:300, max_retries:1, poll_interval:10, poll_timeout:1200, seconds:'4', size:'', video_resolution:'', seed:'', request_mode:'auto', image_input_mode:'auto', input_reference_field:'input_reference', max_download_mb:500, extra_form:'', proxy_url:'' },
